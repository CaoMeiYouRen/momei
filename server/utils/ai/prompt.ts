export const AI_PROMPTS = {
    ...
    TRANSLATE_NAME: 'Translate the following term from any language to {{to}}. Output ONLY the translated term, no explanation or punctuation: \n\n{{name}}',
    SUGGEST_SLUG_FROM_NAME: 'Based on the name "{{name}}", create a concise, lowercase, URL-friendly slug. If it is already a slug, return it. Output ONLY the slug text: \n\n{{name}}',
}
