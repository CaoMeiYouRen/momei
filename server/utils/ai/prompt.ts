export const AI_PROMPTS = {
    ...
    SUGGEST_IMAGE_PROMPT:
        ...
        + 'All five values MUST be written in {{language}} (except unavoidable proper nouns).\n'
        ...
        + 'Use a concrete and vivid style, avoid generic filler like "professional", "nice", "good-looking" without specifics.\n'
        + 'Prefer these style anchors when relevant:\n'
        ...
        + 'For post-cover text, prioritize one short readable headline lockup instead of long paragraph-like copy.\n'
    ...
    EXPAND:
        ...
        + 'factual accuracy, and markdown formatting. '
        + 'Use a {{style}} style when expanding. '
    ...
    CONDENSE:
        ...
        + 'Use a {{style}} style when condensing. '
