...
describe('ImageService', () => {
    ...
    describe('generateImage', () => {
        ...
        it('should process image generation in background', async () => {
            ...
            vi.mocked(aiUtils.getAIImageProviderWithFallback).mockResolvedValue(mockProvider)
        ...
        it('should not auto apply illustration assets even when applyToPost is true', async () => {
            const post = {
                id: 'post-123',
                language: 'en-US',
                translationId: 'cluster-1',
        ...
        it('should complete stale image task from provider checkpoint without regenerating', async () => {
            ...
            expect(aiUtils.getAIImageProviderWithFallback).not.toHaveBeenCalled()
            expect(uploadService.uploadFromUrl).toHaveBeenCalledWith(
