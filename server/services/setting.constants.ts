...
export const SETTING_ENV_MAP: Record<string, string> = {
    ...
    [SettingKey.AI_TEMPERATURE]: 'AI_TEMPERATURE',
    [SettingKey.AI_CHUNK_SIZE]: 'AI_CHUNK_SIZE',
    [SettingKey.AI_FALLBACK_PROVIDER]: 'AI_FALLBACK_PROVIDER',
    [SettingKey.AI_FALLBACK_API_KEY]: 'AI_FALLBACK_API_KEY',
    [SettingKey.AI_FALLBACK_MODEL]: 'AI_FALLBACK_MODEL',
    [SettingKey.AI_FALLBACK_ENDPOINT]: 'AI_FALLBACK_ENDPOINT',
    ...
    [SettingKey.UMAMI_ANALYTICS]: 'NUXT_PUBLIC_UMAMI_ANALYTICS',
    ...
    [SettingKey.TTS_CREDENTIAL_TTL_SECONDS]: 'TTS_CREDENTIAL_TTL_SECONDS',
    [SettingKey.TTS_VOLCENGINE_APP_ID]: 'TTS_VOLCENGINE_APP_ID',
    [SettingKey.TTS_VOLCENGINE_ACCESS_KEY]: 'TTS_VOLCENGINE_ACCESS_KEY',
...
const SETTING_DEFAULT_MAP: Partial<Record<string, string>> = {
    ...
    [SettingKey.AI_TEMPERATURE]: '70',
    [SettingKey.AI_CHUNK_SIZE]: '4096',
    [SettingKey.TTS_CREDENTIAL_TTL_SECONDS]: '600',
}
