            ...
            loader: async () => {
                ...
                return {
                    ...
                    data: {
                        ...
                        showComplianceInfo: isEnabledSetting(asStringSetting(settings[SettingKey.SHOW_COMPLIANCE_INFO])),
                        ...
                        live2dEnabled: isEnabledSetting(asStringSetting(settings[SettingKey.LIVE2D_ENABLED])),
                        ...
                        live2dMobileEnabled: isEnabledSetting(asStringSetting(settings[SettingKey.LIVE2D_MOBILE_ENABLED])),
                        ...
                        canvasNestEnabled: isEnabledSetting(asStringSetting(settings[SettingKey.CANVAS_NEST_ENABLED])),
                        canvasNestOptionsJson: settings[SettingKey.CANVAS_NEST_OPTIONS_JSON] || '',
                        canvasNestMobileEnabled: isEnabledSetting(asStringSetting(settings[SettingKey.CANVAS_NEST_MOBILE_ENABLED])),
                        ...
                        aiEnabled: isEnabledSetting(asStringSetting(settings[SettingKey.AI_ENABLED])),
                        asrEnabled: isEnabledSetting(asStringSetting(settings[SettingKey.ASR_ENABLED])) || ((
                            !!process.env.ASR_API_KEY
                            || !!settings[SettingKey.VOLCENGINE_APP_ID]
                        ) && asStringSetting(settings[SettingKey.ASR_ENABLED]) !== 'false'),
                        ttsEnabled: isEnabledSetting(asStringSetting(settings[SettingKey.TTS_ENABLED])) || (!!process.env.TTS_API_KEY && asStringSetting(settings[SettingKey.TTS_ENABLED]) !== 'false'),
                        externalFeedEnabled: isEnabledSetting(asStringSetting(settings[SettingKey.EXTERNAL_FEED_ENABLED])),
                        externalFeedHomeEnabled: isEnabledSetting(asStringSetting(settings[SettingKey.EXTERNAL_FEED_HOME_ENABLED])),
