...
export default defineEventHandler(async () => {
    try {
        ...
        const publicKeys = [
            ...
            SettingKey.FOOTER_COPYRIGHT_OWNER,
            SettingKey.FOOTER_COPYRIGHT_START_YEAR,
        ...
        return {
            ...
            data: {
                ...
                footerCopyrightOwner: settings[SettingKey.FOOTER_COPYRIGHT_OWNER],
                footerCopyrightStartYear: settings[SettingKey.FOOTER_COPYRIGHT_START_YEAR],
