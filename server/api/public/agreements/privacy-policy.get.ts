...
function getDefaultPrivacyPolicy(): string {
    return `<div class="legal-page__content">
        ...
        <section>
            ...
            <p>我们可能收集以下类型的信息：</p>
            <ul>
                <li><strong>您直接提供的信息</strong>：如注册账户时输入的名称、邮箱地址、头像等。</li>
                <li><strong>自动收集的信息</strong>：如您的 IP 地址、浏览器类型、访问时间、浏览的页面等。</li>
                <li><strong>Cookies 和类似技术</strong>：用于改善用户体验和站点性能。</li>
            </ul>
        </section>
        ...
        <section>
            <h2>6. 用户权利</h2>
            <p>您有权访问、更正、删除您的个人信息。您也可以随时撤回之前的同意。请与我们联系以行使这些权利。</p>
        </section>
        ...
        <section>
            <h2>8. 联系我们</h2>
            <p>如您对本隐私政策有任何疑问或想行使您的权利，请通过本网站提供的联系方式与我们联系。</p>
        </section>
    </div>`
}
