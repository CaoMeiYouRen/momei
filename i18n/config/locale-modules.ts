export const LOCALE_MESSAGE_MODULE_GROUPS = {
    ...
    public: ['pages.submit', 'pages.posts', 'pages.error', 'pages.user_agreement', 'pages.privacy_policy', 'pages.about', 'pages.links', 'pages.categories_index', 'pages.tags_index', 'pages.archives', 'pages.enhanced_pack'],
