...
export const APP_LOCALE_REGISTRY = [
    {
        ...
        feedEnabled: true,
        ogLocale: 'zh_CN',
        ogAlternateLocales: ['zh_TW', 'en_US', 'ko_KR', 'ja_JP'],
    },
    {
        code: 'zh-TW',
        languageTag: 'zh-TW',
        ...
        feedEnabled: true,
        ogLocale: 'zh_TW',
        ogAlternateLocales: ['zh_CN', 'en_US', 'ko_KR', 'ja_JP'],
    },
    {
        code: 'en-US',
        languageTag: 'en-US',
        ...
        feedEnabled: true,
        ogLocale: 'en_US',
        ogAlternateLocales: ['zh_CN', 'zh_TW', 'ko_KR', 'ja_JP'],
    },
    {
        code: 'ko-KR',
        languageTag: 'ko-KR',
        ...
        feedEnabled: true,
        ogLocale: 'ko_KR',
        ogAlternateLocales: ['zh_CN', 'zh_TW', 'en_US', 'ja_JP'],
    },
    {
        code: 'ja-JP',
        languageTag: 'ja-JP',
        ...
        feedEnabled: true,
        ogLocale: 'ja_JP',
        ogAlternateLocales: ['zh_CN', 'zh_TW', 'en_US', 'ko_KR'],
    },
