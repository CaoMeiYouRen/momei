                ...
                sidebar: [
                    ...
                    },
                    {
                        ...
                        items: [
                            ...
                            { text: '商业化转型重评框架（归档）', link: '/design/governance/archive/commercialization-reassessment-framework' },
                            ...
                            { text: '远程仓库同步评估（Hexo 风格，归档）', link: '/design/governance/archive/hexo-repository-sync' },
                            { text: '文档翻译 freshness 治理', link: '/design/governance/docs-translation-freshness-governance' },
                            { text: '文章分享系统（归档）', link: '/design/governance/archive/post-sharing' },
                            ...
                            { text: 'AI 初始化 / 配置助手评估（归档）', link: '/design/governance/archive/ai-setup-assistant-evaluation' },
                            ...
                            { text: 'E2E 测试增强（归档）', link: '/design/governance/archive/e2e-testing-enhancement' },
                            { text: 'E2E 覆盖矩阵（归档）', link: '/design/governance/archive/e2e-coverage-matrix' },
