...
2.  **通知系统与偏好管理 (Notification & Preference System) (P1)**:
    -   **全站通知架构**: 构建统一的通知下发引擎，支持邮件、站内信等多通道投递。
    -   **精细化偏好设置**: 提供中心化的通知管理界面，用户可自主配置通知接收状态。明确区分“系统通知”（强制性，如安全登录、协议变更）与“营销通知”（可选性，如功能推荐、版本更新）。
...
### 10. 国际化体验优化 (i18n Experience Optimization)
- **统一后端 i18n 机制**:
