...
- `roadmap.md`: `403` 行，处于健康窗口（Phase 32-41 已迁入分片归档）。
- `todo-archive.md`: `393` 行，处于健康窗口（Phase 32-41 已迁入分片归档）。
...
- `roadmap.md` 当前保留第三十二至第四十一阶段摘要与第四十二阶段及之后的近线窗口；若后续再次接近 `800` 行，优先按连续阶段区间继续前移归档。
