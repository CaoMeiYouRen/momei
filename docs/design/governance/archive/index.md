...
本目录存放已完成的历史规划稿、评估文档、工程设计与阶段分析报告。以下归档项不再作为当前执行事实源，仅用于历史追溯。

## 阶段规划稿（5）

- [feature-planning-research-2026-06.md](./feature-planning-research-2026-06.md)
- [phase-31-candidate-draft.md](./phase-31-candidate-draft.md)
- [phase-36-plan.md](./phase-36-plan.md)
...
- [backlog-consolidation-plan.md](./backlog-consolidation-plan.md)
- [creator-statistics.md](./creator-statistics.md)
- [e2e-coverage-matrix.md](./e2e-coverage-matrix.md)
- [e2e-testing-enhancement.md](./e2e-testing-enhancement.md)
- [harness-phase-b-quality-gates.md](./harness-phase-b-quality-gates.md)
- [post-sharing.md](./post-sharing.md)

## 阶段分析报告（1）

- [phase-44-test-coverage-gap-analysis.md](./phase-44-test-coverage-gap-analysis.md)
