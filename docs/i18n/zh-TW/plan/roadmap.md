...
- **第二十二階段已正式啟動**：目前正式階段納入六條受控主線，分別是測試有效性增強、週期性回歸任務實盤化、文章批量翻譯編排能力評估、ESLint 規則分階段收緊、時間 / 日期事實源收斂，以及後台文章管理入口前置到頂欄。
- **翻譯頁範圍說明**：本頁現保留第十八至第二十二階段的歸檔與現行階段摘要；詳細驗收標準與任務拆解仍以中文 `roadmap.md`、`todo.md` 為唯一事實源。
