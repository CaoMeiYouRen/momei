...
- **Stage 28 is now formally in progress**: The Chinese source of truth has opened five execution tracks for a single new feature plus four optimizations: the admin content insights dashboard, PostgreSQL CPU / connection-lifecycle balancing, coverage uplift beyond `76%`, i18n runtime-loading governance, and editor Markdown / visual consistency work.
