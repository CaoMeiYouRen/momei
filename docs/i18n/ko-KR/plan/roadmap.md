...
- **24단계는 이제 정식 계획으로 승격되었습니다**: 중국어 `roadmap.md` 와 `todo.md` 에서는 테스트 커버리지와 red-green 유효성, ESLint / 타입 부채의 단계적 강화, 중복 코드 / 순수 함수 수렴, 그리고 증적을 남기는 단계급 회귀 작업 실행이라는 4개 장기 주선을 정식 실행 항목으로 올렸습니다.
