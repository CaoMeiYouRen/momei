# Phase 40 TypeORM + ESLint Regression Archive

> 归档日期: 2026-06-05（第四十三阶段收口滚动归档）
...
- 事实源: [docs/design/governance/archive/typeorm-v1-upgrade-assessment.md](../../design/governance/archive/typeorm-v1-upgrade-assessment.md)
...
- 本轮覆盖：[docs/design/governance/archive/typeorm-v1-upgrade-assessment.md](../../design/governance/archive/typeorm-v1-upgrade-assessment.md)、[server/database/typeorm-adapter.ts](../../../server/database/typeorm-adapter.ts)、[tests/server/database/init-boundary.test.ts](../../../tests/server/database/init-boundary.test.ts)、[tests/server/api/categories/index.get.test.ts](../../../tests/server/api/categories/index.get.test.ts)、[tests/server/api/posts/index.get.test.ts](../../../tests/server/api/posts/index.get.test.ts) 与 [tests/server/api/tags/index.get.test.ts](../../../tests/server/api/tags/index.get.test.ts)。
...
- 本轮覆盖：[docs/design/governance/archive/typeorm-v1-upgrade-assessment.md](../../design/governance/archive/typeorm-v1-upgrade-assessment.md)、[server/database/typeorm-adapter.ts](../../../server/database/typeorm-adapter.ts)、[tests/server/database/init-boundary.test.ts](../../../tests/server/database/init-boundary.test.ts)、[tests/server/api/categories/index.get.test.ts](../../../tests/server/api/categories/index.get.test.ts)、[tests/server/api/posts/index.get.test.ts](../../../tests/server/api/posts/index.get.test.ts)、[tests/server/api/tags/index.get.test.ts](../../../tests/server/api/tags/index.get.test.ts)、[server/utils/translation.ts](../../../server/utils/translation.ts) 与 [server/utils/translation.test.ts](../../../server/utils/translation.test.ts)。
