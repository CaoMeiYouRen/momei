<template>
    <div class="taxonomy-page">
        <div v-if="categoryPending" class="taxonomy-page__header">
            <Skeleton
                width="15rem"
                height="2.5rem"
                class="mb-4"
        ...
        <div v-else-if="categoryError" class="taxonomy-page__error">
        ...
        <div v-else-if="category" class="taxonomy-page__content">
            <header class="taxonomy-page__header">
                <div class="taxonomy-page__badge">
                    {{ $t('common.category') }}
                </div>
