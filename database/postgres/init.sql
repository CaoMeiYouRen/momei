...
CREATE INDEX "IDX_comment_post" ON "momei_comment" ("post_id");
CREATE INDEX "IDX_comment_author" ON "momei_comment" ("author_id");
CREATE INDEX "IDX_comment_parent" ON "momei_comment" ("parent_id");
