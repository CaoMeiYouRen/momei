...
CREATE TABLE "momei_post_view_hourly" (
  ...
  "bucket_hour_utc" datetime NOT NULL,
  "views" integer NOT NULL DEFAULT (0),
  "created_at" datetime NOT NULL DEFAULT (DATETIME('now')),
  "updated_at" datetime NOT NULL DEFAULT (DATETIME('now')),
...
CREATE TABLE "momei_external_links" (
  ...
  "no_follow" boolean NOT NULL DEFAULT (0),
  "show_redirect_page" boolean NOT NULL DEFAULT (1),
...
CREATE TABLE "momei_friend_links" (
  ...
  "health_check_cooldown_until" datetime,
...
CREATE TABLE "momei_setting_audit_logs" (
  ...
  "is_overridden_by_env" boolean NOT NULL DEFAULT (0),
